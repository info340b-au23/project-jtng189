                ...
                <div className="card">
                    <div className="card-body">
                        <div>
                            ...
                            <span className="item-hide">Location: <input type="text" id="location" name="location" defaultValue={pharmacy.address}
                            ></input> </span>
                        </div>
                        <div>
                            ...
                            <span className="item-hide">Number (#): <input type="text" id="phoneNum" name="phoneNum" defaultValue={pharmacy.phoneNumber}
                            ></input></span>
                        </div>
