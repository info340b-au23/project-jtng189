    ...
    return (
        <div className="pharmacy-data col col-sm col-md col-lg">
            <section className="locator">
                <h3>{"Data Information: " + props.pharmacy.name}</h3>
                <div className="card">
                    <div className="card-body">
                        <div>
                            ...
                            <span className="item-hide">Location: <input type="text" id="location" name="location" value={props.pharmacy.address}
                            ></input> </span>
                        </div>
                        <div>
                            ...
                            <span className="item-hide">Number (#): <input type="text" id="phoneNum" name="phoneNum" value={props.pharmacy.phoneNumber}
                            ></input></span>
                        </div>
